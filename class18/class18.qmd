...
Because of its seriousness, the CDC tracks the number of [reported cases in the U.S.](https://www.cdc.gov/pertussis/php/surveillance/pertussis-cases-by-year.html)
...
ggplot(pt.igg.21) +
  ...
  geom_smooth(aes(group=infancy_vac), method="loess", span=1,
